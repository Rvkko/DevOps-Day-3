...
bucket_name = "nbabuckets"  # Change to a unique S3 bucket name
        ...
        glue_client.create_table(
            ...
            TableInput={
                ...
                "StorageDescriptor": {
                    ...
                    "Location": f"s3://{bucket_name}/raw-data/",  # Bucket name used here
...
def configure_athena():
    ...
    try:
        athena_client.start_query_execution(
            ...
            ResultConfiguration={"OutputLocation": athena_output_location},  # Athena output location used here
        )
